...
func (s *MessageService) SendMessage(ctx context.Context, msg *model.Messages) error {
	msg.Status = "sent"
	return s.repo.SaveMessage(ctx, msg)
}

func (s *MessageService) GetConversation(ctx context.Context, userID1, userID2 int) ([]*model.Messages, error) {
